...
export async function renderFolderView(items, path, request) {
  ...
  const intro = `<div class="intro markdown-body" style="text-align: left; margin-top: 2rem;">
                    <h2>Yoo, I'm Kai Sun 👋</h2>
                    <p>This is Kai Sun's OneDrive public directory listing. Feel free to download any files that you find useful. Reach me at: sunkai.tech [at] gmail [dot] com.</p>
                    <p><a href="https://sunkai.tech">Portfolio</a> · <a href="https://sunkai.tech">Blog</a> · <a href="https://github.com/Auto-SK">GitHub</a></p>
                  </div>`
